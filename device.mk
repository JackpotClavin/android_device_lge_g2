...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio_policy.conf:system/etc/audio_policy.bak \
...
PRODUCT_COPY_FILES := \
    ...
    $(LOCAL_PATH)/rootdir/init.galbi.class_core.sh:root/init.galbi.class_core.sh \
    $(LOCAL_PATH)/rootdir/init.galbi.class_main.sh:root/init.galbi.class_main.sh \
    $(LOCAL_PATH)/rootdir/init.galbi.crash.sh:root/init.galbi.crash.sh \
    $(LOCAL_PATH)/rootdir/init.galbi.early_boot.sh:root/init.galbi.early_boot.sh \
    $(LOCAL_PATH)/rootdir/init.galbi.rc:root/init.galbi.rc \
    $(LOCAL_PATH)/rootdir/init.galbi.sh:root/init.galbi.sh \
    $(LOCAL_PATH)/rootdir/init.galbi.syspart_fixup.sh:root/init.galbi.syspart_fixup.sh \
    $(LOCAL_PATH)/rootdir/init.galbi.usb.rc:root/init.galbi.usb.rc \
    $(LOCAL_PATH)/rootdir/init.galbi.usb.sh:root/init.galbi.usb.sh \
    $(LOCAL_PATH)/rootdir/init.galbi-sensor.sh:root/init.galbi-sensor.sh \
    ...
    $(LOCAL_PATH)/rootdir/init.lge.vzw.usb.sh:root/init.lge.vzw.usb.sh \
    ...
    $(LOCAL_PATH)/rootdir/ueventd.g2.rc:root/ueventd.g2.rc:system/etc/ \
